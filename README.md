...
<ul>
  ...
  <li>Identify key churn patterns</li>
  <li>Provide data-driven retention recommendations</li>
</ul>
...
<p>
The data was transformed into a <b>Star Schema</b> for efficient analysis
in Power BI. Relationships were created between relevant customer, service,
contract, payment, and churn attributes.
</p>
...
<ul>
  ...
  <li><b>Revenue & CLTV Analysis</b></li>
...
<ul>
  <li>Month-to-month customers showed higher churn.</li>
  <li>Customers with lower tenure were more likely to churn.</li>
  <li>Certain payment methods showed higher churn rates.</li>
  <li>High-CLTV customers were also present among churned customers.</li>
  <li>Churn varied across customer profiles and services.</li>
</ul>

<h2>💡 Recommendations</h2>

<ul>
  <li>Encourage month-to-month customers to adopt longer-term contracts.</li>
  <li>Strengthen onboarding and engagement for new customers.</li>
  <li>Prioritize high-CLTV customers for retention campaigns.</li>
  <li>Improve the payment experience for high-churn segments.</li>
  <li>Use targeted retention strategies based on customer characteristics.</li>
</ul>
...
<p>
<b>
SQL → Data Cleaning & Analysis → Power Query → Data Modeling → DAX
...
segments, and generate actionable business recommendations.
</p>
